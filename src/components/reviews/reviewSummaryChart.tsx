...
export default function ReviewSummaryChart({
  ...
  return (
    ...
    <div className="mb-5 mt-5">
        <h3>Aviso legal</h3>
        <div><h5><b>Objetivo</b></h5><p>Mediante este “Aviso Legal”, IMPERIAL BILBAINA, S.A. quiere comunicar a los usuarios de su sitio Web la política de protección de datos de carácter personal llevada a cabo, cumpliendo así con el derecho de información que la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal (en adelante LOPD), y la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (en adelante LSSI) reconoce a todos los usuarios.

La información proporcionada en nuestras páginas bajo el dominio “www.imperialbilbaina.com” tiene la finalidad de facilitar el conocimiento y actividades de IMPERIAL BILBAINA, S.A., así como de ofrecer a los usuarios y visitantes el acceso al conjunto de servicios ofertados por nuestra Empresa.

El acceso y posterior utilización de la Web de IMPERIAL BILBAINA, S.A. por parte del usuario implicará su conformidad de forma expresa, plena y sin reservas, con la totalidad de su contenido. El acceso a esta WEB tiene carácter gratuito y su visualización no requiere previa suscripción o registro alguno.</p></div>
      </div>
...
<ul>
<li>Titular página Web: IMPERIAL BILBAINA, S.A.</li>
...
<div><h5><b>Protección de datos de carácter personal</b></h5><p>De conformidad con lo establecido en los artículos 5 y 6 de la Ley Orgánica 15/1999 de 13 de diciembre de Protección de Datos de Carácter Personal (en adelante, LOPD), le informamos que los datos de carácter personal que voluntariamente nos facilite a través de los distintos formularios o direcciones de correo electrónico dispuestos al efecto en la Web “www.imperialbilbaina.com”, o en cualquier otro canal de recogida de los mismos, serán incorporados al fichero denominado “Clientes y/o Proveedores”, debidamente inscrito en la AEPD, responsabilidad de IMPERIAL BILBAINA, S.A. con la finalidad de gestionar y administrar las relaciones comerciales que los clientes/usuarios mantengan con nuestra Empresa, así como para atender las consultas que se requieran sobre nuestros servicios y el envío de información comercial sobre las actividades y servicios prestados por nuestra Empresa.IMPERIAL BILBAINA, S.A. no comunicará ni cederá los datos personales a terceros, sin el consentimiento previo del interesado, tratándolos de forma totalmente confidencial. En caso de que IMPERIAL BILBAINA, S.A. se propusiera ceder a terceros los datos personales de los usuarios recogidos en este sitio, lo comunicará debidamente a los afectados especificando la identidad de los cesionarios y la finalidad con que van a tratar los datos que se ceden.
...
Todos los datos solicitados a través de la Web son obligatorios. En caso de no ser facilitados, IMPERIAL BILBAINA, S.A. no garantiza que los servicios/productos prestados se ajusten completamente a sus necesidades.
...
Los menores de catorce años que procedan a la inclusión de datos personales en los formularios habilitados deberán contar con la autorización previa de sus padres, tutores o representantes legales, a quienes se les advierte que, según la legislación vigente, serán considerados responsables de todos los actos realizados por los menores a su cargo. IMPERIAL BILBAINA, S.A. estará exenta de cualquier responsabilidad por el incumplimiento de este requisito.</p></div>

<div><h5><b>Propiedad intelectual e industrial</b></h5><p>Los contenidos, imágenes y logotipos mostrados en las páginas son propiedad de IMPERIAL BILBAINA, S.A. Queda prohibida su utilización, cesión o reproducción -ya sea parcial o total- aún en caso de mencionarse su origen sin contar con la oportuna autorización.

El Usuario se obliga a respetar los derechos de propiedad industrial de IMPERIAL BILBAINA, S.A. El uso o la concesión de acceso a la página Web no comportan el otorgamiento de derecho alguno sobre las marcas, nombres comerciales o cualquier otro signo distintivo que se utilicen en la misma.

Los contenidos a los que se accede a través de este sitio son propiedad de IMPERIAL BILBAINA, S.A., sin que puedan entenderse cedidos al usuario, en virtud de lo establecido en este Aviso Legal, ninguno de los derechos de explotación que existen o puedan existir sobre dichos contenidos más allá de lo estrictamente necesario para el correcto uso del sitio Web y de sus servicios.
...
<div><h5><b>Links (hipervínculos a direcciones web)</b></h5><p>Los enlaces contenidos en este sitio Web pueden dirigir a contenidos Web de terceros. IMPERIAL BILBAINA, S.A. no asume ninguna responsabilidad por el contenido, informaciones o servicios que pudieran aparecer en dichos sitios, que tendrán exclusivamente carácter informativo y que en ningún caso implican relación alguna entre IMPERIAL BILBAINA, S.A. y las personas o entidades titulares de tales contenidos o titulares de los sitios donde se encuentren.

Asimismo, IMPERIAL BILBAINA, S.A. informa que queda terminantemente prohibido el uso de links direccionados a nuestra página sin nuestro consentimiento previo. IMPERIAL BILBAINA, S.A. no se responsabiliza de los contenidos de las páginas que incluyan links a nuestra página.</p></div>
