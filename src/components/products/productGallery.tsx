    ...
    <>
      <div className="col-12 col-lg-6 d-flex">
        <div className="d-block">
          ...
          <img className="w-90 max-height-150 mb-4 rounded-2" src={images[3].src} alt={images[3].alt} />
          <img className="w-90 max-height-150 rounded-2" src={images[4].src} alt={images[4].alt} />
        </div>
